...
export function filterOrganizationTable(
  ...
  if (query.length > 0) {
    data.forEach((dataEntry) => {
      if (
        dataEntry.name.toString().toLowerCase().includes(query.toLowerCase())
      ) {
...
export function filterUserTable(
  ...
  if (query.trim().length > 0) {
    data.forEach((dataEntry) => {
      if (
        dataEntry.id.toString().toLowerCase().includes(query.toLowerCase()) ||
        dataEntry.username.toLowerCase().includes(query.toLowerCase()) ||
